package nickzxing.order.web.feign.strategy;
 ...
 * Hystrix自定义隔离策略
 * 解决Feign调用远程API传递Header时获取ServletRequestAttributes为NULL的情况
 * 由于Hystrix官方强烈建议使用THREAD隔离策略，又因为THREAD隔离策略无法获取ServletRequestAttributes，所以使用自定义隔离策略
 */
